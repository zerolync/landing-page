  ...
  return (
    <div className="bg-[#1E1E1E] rounded-lg overflow-hidden border border-white/10">
      <div className="flex items-center px-4 py-2 bg-[#2D2D2D] border-b border-white/10">
        ...
        <div className="flex-1 text-center text-sm text-white/60">zerolync_info.sh</div>
      </div>
    ...
    <div className="min-h-screen bg-[#121212] text-white">
      ...
      <nav className="container mx-auto px-6 py-6 flex justify-between items-center fade-in">
        ...
        <div className="flex items-center space-x-8">
          <a href="#features" className="hover:text-gray-300 transition-colors text-sm tracking-wider">Features</a>
          <a href="#about" className="hover:text-gray-300 transition-colors text-sm tracking-wider">About</a>
        ...
        <Terminal>
          <div className="space-y-4">
            ...
            <div className="pl-4 space-y-6">
              <div>
                <h3 className="text-white/90 font-semibold mb-2"># The Challenge</h3>
                <div className="text-gray-400 space-y-2">
                  <p>Users face significant barriers in cross-chain interactions:</p>
                  <div className="pl-4">
              ...
              <div>
                <h3 className="text-white/90 font-semibold mb-2"># Our Innovation</h3>
                <div className="text-gray-400 space-y-2">
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              <a href="https://x.com/zero_lync" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-all hover:scale-110">
                <Twitter className="w-5 h-5" strokeWidth={1.5} />
              </a>
              <a href="https://github.com/zerolync" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-all hover:scale-110">
                <Github className="w-5 h-5" strokeWidth={1.5} />
              </a>
              <a href="mailto:zerolync@gmail.com" className="text-white hover:text-gray-300 transition-all hover:scale-110">
